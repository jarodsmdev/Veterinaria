...
<html>
	...
	<body>
		...
		<main class="container">
			<h2 class="text-center my-5">Editar Número Teléfonico</h2>
			...
			<form action="" method="POST">
				...
				<div class="row justify-content-end mt-2">
					<button type="submit" class="btn btn-success btn-sm w-50 my-2" id="btnEnviar"><i class="fas fa-save"></i> Actualizar</button>
				</div>
			</form>
		</main>
